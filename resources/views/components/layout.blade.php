...
{{--                <img src="/images/logo.png" alt="Laracasts Logo" width="165" height="16">--}}
        ...
        @auth
                ...
                ?>
        @endauth
        <button type="button" id="dark_btn" class="btn btn-secondary text-white">dark Mode</button>
        <button type="button" id="white_btn" class="btn btn-secondary text-white">white Mode</button>
...
{{--            @endauth--}}
            ...
            <button class="bg-blue-500 hover:bg-green-300 ml-2 p-2 rounded-xl"><a href="/carts">The Cart</a>
    ...
    >
        ...
        <h5 class="text-3xl">Subscribe to see our latest products</h5>
